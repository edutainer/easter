class RigidBody{
        ...
        Move() {
            ...
            if (this._isPotentialCollision()) {// Ha lehetséges az ütközés
                this.triggerEvent('PotentialCollisionEventType');
            }
            if (this._isTouchingOfWall()) {// fal
                this.triggerEvent('TouchingOfWallEventType');
            }
            this._movingStep();
                // ? constraints
